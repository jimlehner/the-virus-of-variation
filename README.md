...
## Python Code
Python code is organized by chapter title. Specific figures in the code are labeled in accordance with the numbering scheme in **The Virus of Variation**. In instances where a chapter does not contain figures or calculations using Python, an 'NA' is shown in the list below. The Jupyter notebook files can be found [here](https://github.com/jimlehner/the-virus-of-variation/tree/main/python).
...
## Excel Files
Excel files are organized by chapter title using the same structure as the Python code.  Within each Excel files, is an overview tab, a data tab, and a tab for each of the tables or figures using the naming convention from **The Virus of Variation**. In instances where a chapter does not have an Excel file, 'NA' is shown in the list below. The Excel files can be found [here](https://github.com/jimlehner/the-virus-of-variation/tree/main/excel_files).
